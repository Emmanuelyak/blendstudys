  ...
  return (
    <div className="h-screen relative scrollbar-thumb-{color}">
      <div className="bg-background-color py-5 h-120 w-auto">
        <div className="bg-transparent w-full  fixed top-0 pt-5 pb-10">
      ...
      <div className="bg-main flex flex-col justify-center items-center w-2/5 m-auto">
        <div>
          <h2 className="font-bold 2xl:text-4xl md:text-xl text-center">
            Explore +3000 Test Questions
          </h2>
        ...
        <div className="flex 2xl:w-full lg:w-full justify-center mb-3 gap-2.5 mt-5 ">
          ...
          <div className="2xl:w-28 border border-color rounded flex items-center flex-col pt-2 p-2">
            <div className="mt-3">
      ...
      <div>
        <div>
          ...
          <div className="w-4/6 m-auto text-center">
            <p className="text text-gray-600 mb-7 2xl:text-2xl md:">
              Blend Study App offers personalized test creation, rich resource
              integration, and collaborative study rooms,
              <br /> empowering learners to prepare effectively and succeed in
              their exams
            </p>
          </div>
        </div>
        <div className="2xl:w-9/12 2xl:flex md:w-11/12 md:block m-auto gap-30 items-center mb-10">
          <div className="2xl;w-6/12 flex flex-col justify-center md:ml-10">
            <h1 className="font-bold text-4xl md:text-center">Custom Test Creation</h1>
            <p className="text-gray-600 text-xl mt-3">
              Create engaging assessments across various subjects,
              <br /> complete with levels of difficulty to match the needs of
              every <br /> learner.
            </p>
          </div>
        ...
        <div className="2xl:w-9/12 md:w-11/12 flex md:flex-col m-auto gap-30 items-center mb-10">
          ...
          <div className="2xl:w-6/12 md:order-1 flex flex-col 2xl:justify-center md:justify-start text-left md:left-0 2xl:text-right">
            <h1 className="font-bold text-4xl">Rich Resource Integration</h1>
            <p className="text-gray-600 text-xl mt-3">
        ...
        <div className="w-9/12 flex m-auto gap-30 items-center mb-40">
