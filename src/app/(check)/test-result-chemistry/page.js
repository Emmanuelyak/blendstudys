    ...
    <div className="w-full relative 2xl:mb-0 lg:mb-0 md:mb-0 sm:mb-32">
      ...
      <div className="w-100 m-auto pt-6">
        ...
        <SimpleBar
          forceVisible="y"
          autoHide={false}
          className="w-full 2xl:w-10/12 border mt-10 border-background-color h-ht-3 rounded-xl"
        >
          <div>
            <div>
                  ...
                  <div className="flex lg:gap-20">
                    <div>
                      ...
                      <div>
                        ...
                        industry&lsquo;s standard dummy text ever since the
                        1500s
                      </div>
                    </div>
                  </div>
            ...
            <div className="p-2 lg:px-10 w-11/12 xl:w-8/12 lg:w-9/12 md:w-9/12">
              <div className="flex justify-between py-5 px-10 border border-gray-600 rounded-md mb-4">
                <p>
                  Has been the industry&lsquo;s standard dummy text ever since
                  the 1500s.
                </p>{" "}
                <div>
                  <Image width={100} height={100} src="/checkbox.png" alt="" />
                </div>
              </div>
              <div className="flex justify-between py-5 px-10 border border-gray-600 rounded-md mb-4">
                <p>
