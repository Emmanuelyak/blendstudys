...
function Navigation(props) {
  ...
  return (
    ...
    <div className="bg-transparent backdrop-blur-md filter 2xl:w-full lg:w-full md:w-10/12 fixed top-0 pt-5 pb-10">
      <div  className="bg-white p-2.5 m-auto rounded-xl 2xl:w-9/12  md:w-10/12 top-2.5 2xl:right-20 shadow-lg">
      ...
      <div></div>
      <div className="flex items-center lg:justify-center md:gap-5 2xl:justify-center md:justify-evenly text-gray-700 2xl:text-xl md:text-md 2xl:gap-20 2xl:w-90 lg:w-11/12 md:w-6/12 md:mr-2 cursor-pointer">
        <div
      ...
      <div className="lg:gap-2 2xl:w-1/6 lg:w-1/6  md:w-48 flex md:gap-2 lg:justify-end 2xl:justify-end">
        <div>
